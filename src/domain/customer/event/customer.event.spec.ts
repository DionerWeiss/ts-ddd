...
import { WriteConsole2WhenProductIsCreatedHandler } from "./handler/write-console-2-when-address-is-changed.handler";
import { WriteConsoleWhenAddressIsChanged } from "./handler/write-console-when-customer-is-created.handler";
